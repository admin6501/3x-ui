...
- **Bot de venta de reventas** — un segundo bot de Telegram (con su propio token y su propia lista de administradores, se activa en Ajustes del panel → Telegram → Bot de ventas) que vende paneles de reventa en persa. Define los paquetes en el panel o en el propio bot — precio, cuota de tráfico, plazas de cliente, entradas concedidas; el comprador los consulta, envía el comprobante de pago y, en cuanto lo apruebas, el panel crea su cuenta de revendedor y le envía las credenciales. Comprar de nuevo recarga la misma cuenta en vez de emitir un segundo acceso, y una recarga reactiva una cuenta suspendida por agotar su cuota. El bot también tiene lado de administración: pedidos pendientes, gestión de paquetes, lista de revendedores con activar/desactivar y reinicio de tráfico, cifras de ventas y difusión. La página **Ventas** replica todo eso y permite registrar una venta hecha fuera de Telegram.

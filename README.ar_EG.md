...
- **بوت بيع التوكيلات** — بوت تيليجرام ثانٍ (بتوكن وقائمة مشرفين خاصة به، يُفعَّل من إعدادات اللوحة ← تيليجرام ← بوت البيع) يبيع لوحات التوكيل بالفارسية. تُعرّف الباقات في اللوحة أو داخل البوت — السعر وحصة الترافيك وعدد العملاء والواردات الممنوحة؛ يتصفّحها المشتري ويرسل إيصال الدفع، وبعد موافقتك تُنشئ اللوحة حساب التوكيل وترسل له بيانات الدخول. الشراء مجددًا يشحن الحساب نفسه بدل إصدار حساب ثانٍ، ويعيد تشغيل حساب أُوقف لنفاد حصته. للبوت أيضًا جانب إداري: الطلبات المعلّقة وإدارة الباقات وقائمة الموزّعين مع التفعيل/التعطيل وتصفير الترافيك وأرقام المبيعات ورسالة جماعية. صفحة **المبيعات** في اللوحة تعكس ذلك كله، وتتيح تسجيل بيعة تمّت خارج تيليجرام.

...
// which the form offers as ready-made SNI values.
...
// verdict ranked by feasibility then latency, so a target can be picked from a
// list rather than typed from memory.

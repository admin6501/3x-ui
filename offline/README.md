...
- `bin/` — `xray-linux-amd64` (Xray-core v26.6.22), `mtg-linux-amd64`
  (MTProto, v2.2.8), and geo data: `geoip.dat`, `geosite.dat`,
  `geoip_IR.dat`, `geosite_IR.dat`, `geoip_RU.dat`, `geosite_RU.dat`.
